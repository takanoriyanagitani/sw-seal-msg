...
import func SealMessage.file2sealed2opened2stdout
...
struct sealed2msg {
  static func main() {
    ...
    let sealedFilename: String = env["ENV_IN_SEALED_FILENAME"] ?? ""
    ...
    let wrote: Result<(), Error> = file2sealed2opened2stdout(
      sealedFilename,
    ...
    do {
      ...
      print("unable to write the opened message.")
    }
  }
}
